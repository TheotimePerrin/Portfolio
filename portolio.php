  ...
  <div class="container">
    <header>
      <div class="brand">
        ...
        <div>
          <div class="title">Théotime Perrin</div>
          <div class="subtitle">BTS SIO — SLAM · Développeur web junior</div>
        </div>
      </div>
    ...
    <main>
      ...
      <aside class="card" aria-labelledby="profile-title">
        <div id="profile-title" class="profile">
          ...
          <div>
            ...
            <div class="tag">Développeur web | Frontend & Backend</div>
          </div>
        </div>
        ...
        <div style="margin-top:14px;color:var(--muted);font-size:13px">
          <strong>Veille :</strong> Sécurité des API · Bonnes pratiques REST · Tests unitaires
        </div>
      </aside>
      ...
      <section>
        <div class="hero card">
          <h1>Bonjour — je m'appelle Théotime Perrin</h1>
          <p id="about">Développeur web en formation (BTS SIO SLAM). Passionné par la création d'applications intuitives et performantes. (Phrase d'accroche modifiable)</p>
        </div>
        ...
        <div class="card" id="projects">
          ...
          <div class="projects-grid">
            ...
            <article class="project">
              ...
              <h3>Netflix (Clone)</h3>
              <div class="meta">2024 · HTML · CSS · JavaScript · API</div>
              <p>Clone d'une interface de streaming : catalogue dynamique, filtres, et lecture fictive. Permet de mettre en avant la gestion d'APIs et l'UI/UX.</p>
              <div class="actions">
            ...
            <article class="project">
              ...
              <h3>Monopoly (Jeu)</h3>
              <div class="meta">2023 · JavaScript · Canvas · Node (optionnel)</div>
              <p>Adaptation digitale d'un jeu de plateau : gestion du plateau, tours de jeu, et logique d'achats/ventes. Bon exemple de logique métier et architecture JS.</p>
              <div class="actions">
                <a class="btn" href="https://github.com/TheotimePerrin" target="_blank" rel="noopener">Voir le code</a>
                <a class="btn secondary" href="#">Démo</a>
              </div>
            ...
            <article class="project">
              <div class="thumb">Nouveau</div>
              <h3>Projet à venir</h3>
              <div class="meta">—</div>
              <p>Ajoute ici d'autres projets réalisés en stage, en TP ou personnel — exemple : applications CRUD, API REST, mini-frameworks, etc.</p>
              <div class="actions">
                <a class="btn secondary" href="#">Modifier</a>
              </div>
            </article>
